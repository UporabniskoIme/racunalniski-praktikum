...
Algoritem je nalje implementirati tako, da do kršenja strogih omejitev sploh ne more priti.
...
%
\[
   k_1 \cdot u_1 + k_2 \cdot u_2 + \dotsc + k_{n-1} \cdot u_{n-1} + k_n \cdot u_n 
\]
%
